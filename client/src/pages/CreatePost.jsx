    ...
    return (
        <section className="max-w-3xl mx-auto">
             <div>
                ...
                <p className="mt-2 text-[#666e75] max-w-[500px] text-[16px]">Create imaginative and visually stunning images through generated by DALL-E AI and share them with the community</p>
            </div>
